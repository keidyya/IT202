...
if (isset($_POST["name"])) {
    ...
    if ($cost > $balance) {
        ...
        $query = "INSERT INTO Comps (name, duration, expires, cost, min_score, first_place_per, second_place_per, third_place_per, fee, user_id, reward) VALUES(:name, :duration, :expires, :cost, :min_score, :fp, :sp, :tp, :fee, :uid, :reward)";
